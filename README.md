...
Single page frontend template for #BringHoustonOnline initiative.
...
## Serving secure (https) version of site

To serve `https` version of the website, add or edit the `.htaccess` file at the websites root folder and include this:

```
RewriteEngine On
RewriteCond %{SERVER_PORT} 80
RewriteRule ^(.*)$ https://www.alrightroofingandremodeling.com/$1 [R,L]
```